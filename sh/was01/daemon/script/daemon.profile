...
export JEUS_LIBS=/HIC_APP/jeus/webhome/app_home/cabis/WEB-INF/lib
export JEUS_CLASS=/HIC_APP/jeus/webhome/app_home/cabis/WEB-INF/classes
export JEUS_DBLIB=/HIC_APP/jeus/lib/datasource
export JEUS_APPLIB=/HIC_APP/jeus/lib/application
export JEUS_SYSLIB=/HIC_APP/jeus/lib/system
