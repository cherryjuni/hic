...
public class SenderL {
	 ...
	 */
	public SenderL() throws Exception {
		clients = new Vector();
	...
	public static void main(String[] args) throws Exception {
		try{
			if(args[0] == null) 
				...
				SenderL.sPORT = Integer.parseInt(args[0]);
			SenderL server = new SenderL();
			System.out.println("=========================================================");
	...
	class Listener extends Thread {
		...
		public Listener() throws Exception {
			ss = new ServerSocket(SenderL.sPORT);
		}
				...
				for(;;) {
					...
					switch(orgCode) {
						...
						case 13:
							...
							PORT = 16351;  //port : 운영 16350, 테스트 16351
							break;
						case 14:
							// KCB  (kkmin,20061228)
							IP   = "219.255.136.242";
