...
//					,    실제전문.substring(SOCKET_LEN + 81, SOCKET_LEN + 314 - 실제전문한글수));
	...
	@Test
	public void test성공_이체_우리에서_하나로() { // 081 하나 77291008148507
		//       ----------------------------         ####====----========-===-========---------=----====rrryyyymmddhhmm4s0######=-bankcode*--------------------------------------------------------------------------------------------------------------------------------------------------------------m234------------------------------------ssssss12341234567890
		String[] 우리은행_지급공통전문        = {   "06040600000920032902000052003290220032902 302001100000",                  "20000009200                                                                                                                                                                                                      000000              "};
		//                                            금액정보--------------------------------입금계좌부====================================    출금계좌부--------------------------------------------개별부----------------------------------------------------------------------------------------------------------------------------------------------------------
		//       ----------------------------         -------------=-------------=============bankcode==n234567890123456name567890123456name    bankcode00n23456789012345nPASSWORDname567890123456name=====---==--------======--========------==--------======--========------==--------======--===------------00000------============================================
		String[] 우리은행_지급거래전문        = {   "0000001000000 000000000000000000000000000000008810177291008148507  김정자              ", "00000020001002638811651           하이캐피탈          0000000000              00              00              00              00              00               00000                                                  " };
	...
	// 
//	@Test
	public void test실패_이체_우리에서_하나로_입금정지등록계좌_지급계좌없음() { // 081 하나
		//       ----------------------------        ####====----========-===-========---------=----====rrryyyymmddhhmm4s0######=-bankcode*--------------------------------------------------------------------------------------------------------------------------------------------------------------m234------------------------------------ssssss12341234567890
		String[] 우리은행_지급공통전문        = {   "06040600000920032902000052003290220032902 302001100466",                  "20000009200                                                                                                                                                                                                      000000              "};
		//                                            금액정보--------------------------------입금계좌부====================================    출금계좌부--------------------------------------------개별부----------------------------------------------------------------------------------------------------------------------------------------------------------
		//       ----------------------------        -------------=-------------=============bankcode==n234567890123456name567890123456name    bankcode00n23456789012345nPASSWORDname567890123456name=====---==--------======--========------==--------======--========------==--------======--===------------00000------============================================
		String[] 우리은행_지급거래전문        = {   "0000001000000 000000000000000000000000000000008810145181001195105  김정수              ", "00000020001002638811651           하이캐피탈          0000000000              00              00              00              00              00               00000                                                  " };
	...
	@Test
	public void test성공_이체_우리에서_농협으로() { // 003 농협
		//       ----------------------------         ####====----========-===-========---------=----====rrryyyymmddhhmm4s0######=-bankcode*--------------------------------------------------------------------------------------------------------------------------------------------------------------m234------------------------------------ssssss12341234567890
		String[] 우리은행_지급공통전문        = {    "06040600000920032902000052003290220032902 302001100000",                  "20000009200                                                                                                                                                                                                      000000              "};
		//                                            금액정보--------------------------------입금계좌부====================================    출금계좌부--------------------------------------------개별부----------------------------------------------------------------------------------------------------------------------------------------------------------
		//       ----------------------------         -------------=-------------=============bankcode==n234567890123456name567890123456name    bankcode00n23456789012345nPASSWORDname567890123456name=====---==--------======--========------==--------======--========------==--------======--===------------00000------============================================
		String[] 우리은행_지급거래전문        = {    "0000001000000 000000000000000000000000000000008030100305988001011  김대현              ", "00000020001002638811651           하이캐피탈          0000000000              00              00              00              00              00               00000                                                  " };
